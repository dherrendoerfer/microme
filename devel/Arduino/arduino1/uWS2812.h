 ...
 *    based entirely on the light weight WS2812 lib V2.1 
 *        (C) 2014 by Tim (cpldcpu@gmail.com) 
 *
...
#if w_lowtime>550
   #error "uWS2812: Sorry, the clock speed is too low. Did you set F_CPU correctly?"
#elif w_lowtime>450
   #warning "uWS2812: The timing is critical and may only work on WS2812B, not on WS2812(S)."
...
void ws_2812_select_port(uint8_t pin)
{
  pinMask = digitalPinToBitMask(pin);
  ws2812_port = (unsigned char*)portOutputRegister(digitalPinToPort(pin));
